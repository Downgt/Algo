...
void Zombies::displayFile(string fileName){
...
void Zombies::Choice(string fileName){
...
void Zombies::displayString(double proba, int pos){
...
void Zombies::wetherRandom(double position, double tableauProbabilite[], int size){
